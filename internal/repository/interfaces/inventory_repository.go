...
type InventoryRepository interface {
	...
	GetByProductAndLocation(ctx context.Context, productID, locationID uuid.UUID) (*models.Inventory, error)
	...
	GetByLocation(ctx context.Context, locationID uuid.UUID) ([]*models.Inventory, error)
	GetLowStock(ctx context.Context) ([]*models.Inventory, error)
	GetZeroStock(ctx context.Context) ([]*models.Inventory, error)
	UpdateQuantity(ctx context.Context, productID, locationID uuid.UUID, quantity int) error
