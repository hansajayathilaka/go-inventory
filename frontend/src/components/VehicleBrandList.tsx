...
const VehicleBrandList: React.FC<VehicleBrandListProps> = ({
  ...
  const renderVehicleBrandCard = (vehicleBrand: VehicleBrand) => (
    <div key={vehicleBrand.id} className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
      <div className="p-4">
        {/* Header */}
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-start space-x-3 min-w-0 flex-1">
            ...
            <div className="flex-shrink-0 w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center">
              ...
              <Car className="h-4 w-4 text-gray-400" style={{ display: vehicleBrand.logo_url ? 'none' : 'block' }} />
            </div>
            <div className="min-w-0 flex-1">
              ...
              {vehicleBrand.code && (
                <p className="text-xs text-gray-500">#{vehicleBrand.code}</p>
              )}
            </div>
          </div>
  ...
  const renderVehicleBrandRow = (vehicleBrand: VehicleBrand) => (
    <tr key={vehicleBrand.id} className="hover:bg-gray-50">
      <td className="px-4 py-3">
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0">
            ...
            {vehicleBrand.code && (
              <div className="text-xs text-gray-500">#{vehicleBrand.code}</div>
            )}
          </div>
        </div>
      </td>
      ...
      {vehicleBrands.length === 0 ? (
        <div className="bg-white shadow rounded-lg">
          <div className="p-12 text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">No vehicle brands found</h3>
